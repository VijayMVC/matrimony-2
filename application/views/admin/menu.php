...
<?php /*?><div iconCls="icon-page" href="<?php echo site_url('page/admin/page')?>">Pages</div><?php */?>
<div iconCls="icon-page" href="<?php echo site_url('member/admin/member')?>">Members</div>
</div>
