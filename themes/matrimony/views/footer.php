    ...
    <script src="<?php echo theme_url()?>assets/js/bootstrap-datetimepicker.min.js"></script>
   
<?php /*?>   <script type="text/javascript" src="<?php echo theme_url()?>assets/js/jquery-2.0.0.min.js"></script><?php */?>
	<script type="text/javascript" src="<?php echo theme_url()?>assets/js/jquery.smartWizard.js"></script>
